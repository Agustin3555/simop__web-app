...
export const TipoRecepcionService: Service<TipoRecepcionModel.Entity> = {
  ...
  getForConnect: async () => {
    ...
    return TipoRecepcionAdapter.getForConnect.output(response.data)
  },
  ...
  create: async (data: TipoRecepcionModel.CreateData) => {
    const adaptedInput = TipoRecepcionAdapter.create.input(data)

    await publicInstance.post(collection(), adaptedInput)
  },
  updateOne: async (id, data: TipoRecepcionModel.UpdateData) => {
